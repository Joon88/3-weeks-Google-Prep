...
public class Solution {
    ...
    public static int maxWeight1(int n, int cap, int[] weights, int[] profits) {
        if(n == 0 || cap == 0)
            return 0;
        if(memo[n][cap] >= 0)
            return memo[n][cap];
    ...
    public static int maxWeight2(int n, int cap, int[] weights, int[] profits) {
    ...
    public static int maxWeight3(int n, int cap, int[] weights, int[] profits) {
    ...
    public static int maxWeight4(int n, int cap, int[] weights, int[] profits) {
